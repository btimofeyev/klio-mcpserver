...
export class ContentFormatter {
   ...
   */
  private static getUrgencyIndicator(material: MaterialData): string {
   ...
   */
  private static getGradeIndicator(material: MaterialData): string {
   ...
   */
  private static formatHeader(material: MaterialData): string {
    const sections: string[] = [];
   ...
   */
  private static formatLessonJson(material: MaterialData): string[] {
    const sections: string[] = [];
    ...
    try {
      ...
      if (lessonData.learning_objectives?.length > 0) {
        ...
        lessonData.learning_objectives.forEach((obj: string, index: number) => {
   ...
   */
  private static generateMetadata(material: MaterialData): any {
    const metadata: any = {
   ...
   */
  private static getGradeLevel(percentage: number): string {
   ...
   */
  private static isOverdue(material: MaterialData): boolean {

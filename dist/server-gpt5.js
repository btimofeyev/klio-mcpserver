...
The server intelligently routes queries to appropriate content types and applies educational prioritization for optimal AI tutoring support.
    ...
    // ===============================
    mcpServer.tool('search', 'Intelligent search for educational materials with natural language understanding and educational prioritization', {
    ...
    // ENHANCED FETCH TOOL  
    // ===============================
    mcpServer.tool('fetch', 'Retrieve complete educational material with enhanced formatting and tutoring context', {
...
// Start the enhanced server
startEnhancedServer();
//# sourceMappingURL=server-gpt5.js.map